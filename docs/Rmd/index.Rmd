...
Also, erroneous degree symbol encoding in axis label on the updated plot only occurs in this rendered markdown document, for now. It does not occur in web applications.*]
